...
boolean M_WriteFile (char const *name, void *source, int length)
{
	...
	extern void F_StoreSaveGame(const char*, byte*, int);
	F_StoreSaveGame(name, source, length);
...
{
	extern int F_LoadSaveGame(const char*, byte**);
	return F_LoadSaveGame(name, buffer);
...
/*#ifdef __NeXT__
	...
	#define DEFAULT_SAVEPATH		"hexndata\\"
#endif*/
	#define DEFAULT_SAVEPATH		"hexndata/"	// MIKE
