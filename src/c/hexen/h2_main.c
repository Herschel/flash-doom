...
// static void DrawAndBlit(void); MIKE
...
boolean singletics = true;			// debug flag to cancel adaptiveness MIKE
...
void H2_Main(void)
{
	...
	startmap = 1;
	shareware = true; // Always fnalse for Hexen
